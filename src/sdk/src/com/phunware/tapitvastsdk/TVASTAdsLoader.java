...
public class TVASTAdsLoader {
    ...
    private class DownloadXmlTask extends AsyncTask<String, Void, Object> {
        ...
        protected void onPostExecute(Object result) {
            ...
            // error conditions
                ...
                Log.d("TapItVASTSDK", "XmlPullParserException: " + ((XmlPullParserException) result).toString());
                ...
                Log.d("TapItVASTSDK", "IOException: " + ((IOException) result).toString());
    ...
    public void requestAds(TVASTAdsRequest adRequest) {
        ...
        Log.d("TapIt", "request URL: " + requestURL);
